...
public class FileService {
    ...
    public Response getFile(@PathParam(value = "module") String module,
	    @PathParam(value = "filename") String filename) throws IOException {
	String filePath = "com.glueball.snoop.module." + module + "Module/"
		+ filename;
    ...
    @Produces("image/png")
    @Path("/image/{filename}")
    public Response getImage(@PathParam(value = "filename") String filename)
	    throws IOException {
